...
consumer = KafkaConsumer(bootstrap_servers=['127.0.0.1:9092'], group_id='news_classifier')
...
worker = Worker(topic='news-scan', consumer=consumer, callback=processResult)
